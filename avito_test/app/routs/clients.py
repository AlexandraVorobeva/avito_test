...
def get_all_info_about_client(client_id: int, services: ClientService = Depends()):
...
def get_operations_for_client(client_id: int, services: ClientService = Depends()):
...
def get_clients_balance(
    client_id: int, currency: CurrencyKind, services: ClientService = Depends()
):
